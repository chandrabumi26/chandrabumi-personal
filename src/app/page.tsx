  ...
  return (
    <main className="grid grid-cols-2 grid-rows-2 h-screen w-full">
      ...
      <div className="flex pt-10 pl-10">
        <Link href="/contact-me" className="group bg-[#FDF3C3] border-[10px] border-solid border-[#D6B980] w-[350px] h-[350px] rounded-2xl flex flex-col items-center justify-center gap-6 text-black cursor-pointer">
